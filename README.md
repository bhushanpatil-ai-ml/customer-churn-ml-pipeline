...
![GitHub Repo stars](https://img.shields.io/github/stars/bhushanpatil-ai-ml/customer-churn-ml-pipeline)
![Python](https://img.shields.io/badge/Python-3.x-blue)
![Machine Learning](https://img.shields.io/badge/Machine-Learning-green)
![Scikit Learn](https://img.shields.io/badge/Scikit--Learn-orange)
![Model](https://img.shields.io/badge/Model-Classification-red)
![License](https://img.shields.io/badge/License-MIT-yellow)

End-to-End Machine Learning Pipeline for predicting telecom customer churn using classification models.

This project builds a complete ML workflow to predict whether a telecom customer is likely to churn (leave the service). The pipeline includes **data preprocessing, feature engineering, model training, evaluation, and model saving**.
...
Customer churn is a major challenge for telecom companies. Acquiring new customers is significantly more expensive than retaining existing ones.

Predicting churn helps businesses identify customers who are likely to leave and take proactive steps to retain them.
